...
def extract_mysql_consolidate(): # extract mysql and store to staging area on postgresql dạng table
    db_sv = sql.create_engine('mysql+mysqlconnector://root:toan123@172.18.0.9:3306/qlsv_gv') #root:toan123@localhost:3307  172.18.0.9:3307
    ...
    engine_postgre = sql.create_engine('postgresql://airflow:airflow@172.18.0.11:5432/qlsv_gv')  #airflow:airflow@localhost:5432  172.18.0.11:5432
...
def transform_teacher():
    engine_postgre = sql.create_engine('postgresql://airflow:airflow@172.18.0.11:5432/qlsv_gv')
...
def transform_point():
    engine_postgre = sql.create_engine('postgresql://airflow:airflow@172.18.0.11:5432/qlsv_gv') #, Score_tk2, Score_tk3, Score_th1, Score_th2, Score_th3, Score_gk, Score_ck
...
with DAG('ETL_qlsv_data', default_args= default_dag, description= 'Apache Airflow QLSV AND GV', schedule= timedelta(days=1)) as dag:
    ...
    extract_mysql >> Dim_transfrom_to_postgresql >> Dim_transform_point_and_stg >> Fact_transform_table